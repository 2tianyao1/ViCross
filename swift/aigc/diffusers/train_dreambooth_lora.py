...
These are LoRA adaption weights for {base_model}. The weights were trained on {prompt} using
[DreamBooth](https://dreambooth.github.io/). You can find some example images in the following. \n
{img_str}
...
def parse_args(input_args=None):
    ...
    parser.add_argument(
        ...
        default=None,
        required=True,
        help='A folder containing the training data_1 of instance images.',
    )
    parser.add_argument(
        '--class_data_dir',
        type=str,
