...
This pipeline was finetuned from **{args.pretrained_model_name_or_path}** on the **{args.dataset_name}** dataset. Below
are some example images generated with the finetuned pipeline using the following prompts: {args.validation_prompts}: \n
{img_str}
...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help=('A folder containing the training data_1. Folder contents must follow the structure described in'
