...
def parse_args(input_args=None):
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help=('The name of the Dataset (from the HuggingFace hub) containing the training data_1 of '
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help=('A folder containing the training data_1. '),
    )
    ...
    parser.add_argument('--repeats', type=int, default=1, help='How many times to repeat the training data_1.')
    ...
    parser.add_argument(
        ...
        default=None,
        required=False,
        help='A folder containing the training data_1 of class images.',
    )
    parser.add_argument(
        '--instance_prompt',
        type=str,
    ...
    parser.add_argument(
        ...
        default=0,
        help=(
            'Number of subprocesses to use for data_1 loading. 0 means that the data_1 will be loaded in the main process.'
        ),
    )
    ...
    if args.with_prior_preservation:
        if args.class_data_dir is None:
            raise ValueError('You must specify a data_1 directory for class images.')
...
class DreamBoothDataset(Dataset):
    ...
    def __init__(
        ...
        # we load the training data_1 using load_dataset
        if args.dataset_name is not None:
            try:
                from datasets import load_dataset
            except ImportError:
                raise ImportError(
                    'You are trying to load your data_1 using the datasets library. If you wish to train using custom '
