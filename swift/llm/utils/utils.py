...
def _prepare_inputs(model: PreTrainedModel,
    ...
    example = {
        ...
        'new_bbox': kwargs.pop('new_bbox', None) or [],
        'crop_ped_images': kwargs.pop('crop_ped_images', None) or [],
...
def inference(model: PreTrainedModel,
    ...
    inputs.pop("crossing_point_bbox", None)
    inputs.pop("past_bbox", None)
...
def inference_class(model: PreTrainedModel,
              template: Template,
              query: str,
              history: Optional[History] = None,
              system: Optional[str] = None,
