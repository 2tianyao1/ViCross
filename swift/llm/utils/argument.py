...
class SftArguments(ArgumentsBase):
    dataset: Literal['pie', 'jaad_all', 'jaad_beh'] = 'jaad_beh'
    prompt_length: Literal['short', 'medium', 'long'] = 'medium'
    path_dataset_config : str = '/home/ty/code/ty/code/PAA/pekinese/PAALLM_V4_1/ty/configs'
    path_bbox_image: str = '/data1/ty/code/PAA/data/bbox_image'
    use_all_bbox: bool = False
    bg_downsample_ratio: float = 0.5
    pan_resolution_h: int = 224
    pan_resolution_w: int = 448
    pan_patch_size: int = 14
    ped_resolution_h: int = 112
    ped_resolution_w: int = 112
    ped_patch_size: int = 7
    lossweight_class: float = 1
    lossweight_pre: float = 1
    lossweight_obs: float = 1
    crop_resize_ratio: float = 1.5
    ...
    acc_strategy: Literal['token', 'sentence'] = 'sentence'
